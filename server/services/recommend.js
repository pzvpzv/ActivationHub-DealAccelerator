...
import { AIError, AI_MODEL, structuredCall } from "../ai/anthropic.js";
...
const ai = {
  model: AI_MODEL,
  interpretIntent: (query, taxonomy) => interpretIntent(query, taxonomy, { call: structuredCall }),
  explainWithAI: (args) => explainWithAI({ ...args, call: structuredCall }),
